...
{
    public class SubscriptionPreviewTotals
    {
        ...
        public SubscriptionPreviewTotals(
            string subtotal,
            string discount,
            string tax,
            string total,
        ...
        public static SubscriptionPreviewTotals FromDict(JsonElement data)
        {
            return new SubscriptionPreviewTotals(
