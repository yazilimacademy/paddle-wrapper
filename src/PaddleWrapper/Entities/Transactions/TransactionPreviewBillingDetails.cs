...
{
    public class TransactionPreviewBillingDetails
    {
        ...
        public TransactionPreviewBillingDetails(
            bool enableCheckout,
            string paymentTerms,
        ...
        public static TransactionPreviewBillingDetails FromDict(JsonElement data)
        {
            return new TransactionPreviewBillingDetails(
