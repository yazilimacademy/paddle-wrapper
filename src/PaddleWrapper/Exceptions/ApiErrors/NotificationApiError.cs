...
public class NotificationApiError : ApiError
{
    public NotificationApiError(string type, string code, string detail, string documentationUrl, List<FieldError> fieldErrors)
        : base(type, code, detail, documentationUrl, fieldErrors)
    {
    }

    public static NotificationApiError FromJson(JsonElement root)
    {
