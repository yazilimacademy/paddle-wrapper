...
public sealed class SubscriptionPaused : Event
{
    public NotificationSubscription Subscription { get; }

    private SubscriptionPaused(
        string eventId,
        ...
        string? notificationId = null)
    {
        ...
        return new SubscriptionPaused(eventId, eventType, occurredAt, subscription, notificationId);
    }
}