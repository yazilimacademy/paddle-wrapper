...
public sealed class SubscriptionTrialing : Event
{
    public NotificationSubscription Subscription { get; }

    private SubscriptionTrialing(
        string eventId,
        ...
        string? notificationId = null)
    {
        ...
        return new SubscriptionTrialing(eventId, eventType, occurredAt, subscription, notificationId);
    }
}